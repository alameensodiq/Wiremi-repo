            ...
            <View style={{ height: height * 0.9, paddingTop: 10 }}>
              <SectionList
                ...
                renderItem={({ item }) => (
                    ...
                    <Lonely />
                  <View style={{width: width * 0.6}} className="flex-col w-[70%] gap-2">
                    ...
                    <View className="flex-row justify-between items-center">
                        <Text className="text-[#6E6E6E] text-[12px]">$1,200 out of $40,000</Text>
                        <Text className="text-buttonprimary text-[12px]">View details</Text>
                    </View>
                  </View>
                </View>
                )}

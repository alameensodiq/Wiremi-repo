        ...
        >
          <View
            style={{
              ...
              gap: height * 0.02,
              backgroundColor: "rgba(0, 9, 30, 0.06)",
              //   opacity: 0.2,
              zIndex: 2
            }}
          >
            ...
            >
              <View className="flex-row justify-between items-center mb-1">
                ...
                <Text className="text-[20px] text-white">Sell Tesla</Text>
                <Text></Text>
              </View>
            ...
            <View className="flex-row items-center justify-between px-10">
              <View className="flex-row items-center gap-2">
                <Tesla />
                <Text className="text-black text-[14px]">You will receive</Text>
              </View>
              <Text className="text-black text-[14px] font-bold">2 shares</Text>
            </View>
          </View>
          ...
          <View className="flex-row justify-center items-center mt-10">
            <BlueSignInButton
              black
              title="Sell for $45.90"
              onPress={() => {
                router.push("/Invest/SellSuccess");
              }}
            />
          </View>
        </View>

      ...
      className="flex-1">
        ...
        >
          <View className="flex-row justify-between items-center mb-1">
            <TouchableOpacity
              onPress={() => router.push("/Invest/MyInvestmentDetails")}
            >
              <Back />
            </TouchableOpacity>
          ...
          <View className="items-center justify-center">
            <TextLabelBox label="Amount to withdraw" placeholder="Enter amount to withdraw" />
          </View>
          <View
          ...
          >
            <BlueSignInButton
              title="Proceed"
              onPress={() => router.push('/Invest/WithdrawPageSuccess')}
            />
          </View>

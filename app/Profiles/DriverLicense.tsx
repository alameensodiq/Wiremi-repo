        ...
        >
          ...
          >
            <View className="flex-row justify-center items-center gap-2">
                <Capture/>
                <Text className="text-buttonprimary text-[14px]">Capture the front your driver’s liscense</Text>
            </View>
          ...
          >
            <View className="flex-row justify-center items-center gap-2">
                <Capture/>
                <Text className="text-buttonprimary text-[14px]">Capture the back your driver’s liscense</Text>
            </View>
            <View style={{width: 120, height: 40, borderRadius: 10}} className="flex-row justify-center items-center  bg-buttonprimary">
                <Scan/>
                <Text className="text-white text-[14px] ml-2">Scan</Text>
          ...
          >
            <View className="flex-row justify-center  gap-2">
                ...
                <Text className="text-buttonprimary text-[14px]">driver’s liscense</Text>
                </View>
            </View>
            <View style={{width: 120, height: 40, borderRadius: 10}} className="flex-row justify-center items-center  bg-buttonprimary">
                <Scan/>
          ...
          <View className="pt-20 flex-row justify-center">
            <BlueSignInButton
              title="Proceed"
                onPress={() => router.push('/Profiles/KycSuccess')}
            />
          </View>
        </View>
      </SafeAreaView>

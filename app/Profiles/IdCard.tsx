          ...
          >
            ...
            >
              <View className="flex-row justify-center items-center gap-2">
                  <Capture/>
                  <Text className="text-buttonprimary text-[14px]">Capture the front of your ID</Text>
              </View>
            ...
            >
              <View className="flex-row justify-center items-center gap-2">
                  <Capture/>
                  <Text className="text-buttonprimary text-[14px]">Capture the back of your ID</Text>
              </View>
              <View style={{width: 120, height: 40, borderRadius: 10}} className="flex-row justify-center items-center  bg-buttonprimary">
                  <Scan/>
                  <Text className="text-white text-[14px] ml-2">Scan</Text>
            ...
            >
              <View className="flex-row justify-center  gap-2">
                  ...
                  <Text className="text-buttonprimary text-[14px]">Take a picture of you holding the ID card</Text>
                  </View>
              </View>
              <View style={{width: 120, height: 40, borderRadius: 10}} className="flex-row justify-center items-center  bg-buttonprimary">
                  <Scan/>

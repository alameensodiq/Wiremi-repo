    ...
    >
      ...
      >
        <View className="flex-row justify-between items-center mb-1">
          <TouchableOpacity onPress={() => router.push('/Loan/Loans')}>
            <Back />
          </TouchableOpacity>
        ...
        {color ? (
          <View className="pt-6 flex-col justify-between gap-10 position: relative">
            <View className="flex-col items-center gap-1">
              ...
              <Text className="text-[24px] text-buttonprimary font-bold">
                $2,500
              </Text>
            </View>
            <View>
              <View className="flex-row gap-2  w-[90%] mt-1">
                <Loantick />
                <Text>
                  ...
                  and <Text className="font-bold text-[12px] leading-5">1</Text>{" "}
                  final payment of{" "}
                  <Text className="font-bold text-[12px] leading-5">
                    $75.61
                  </Text>
              ...
              <View className="flex-row gap-2 w-[65%] mt-1">
                <Loantick />
                <Text className="leading-5">
                  ...
                  Paid automatically from your account
                </Text>
              </View>
              <View className="flex-row gap-2 w-[65%] mt-1">
                <Loantick />
              ...
              <View
                className="flex-col mt-6 border-b-1 pb-3"
              ...
              >
                ...
                <View className="flex-col gap-1 mt-2">
                  <Text style={{ color: "#777A7E", fontSize: 14 }}>
                    Before you take out your loan, when you accept the credit
                  </Text>
                  <Text style={{ color: "#777A7E", fontSize: 14 }}>
                    agreement. This will leave a footprint on your record.
                  </Text>
                </View>
              </View>
              <View
              ...
              >
                <Text style={{ color: "#00091E", fontSize: 16 }}>
                  *If you have an overdraft, your repayments could{" "}
                </Text>
                <Text style={{ color: "#00091E", fontSize: 16 }}>
                  take you into it
                </Text>
                <View className="flex-col gap-1 mt-2">
                  <Text style={{ color: "#777A7E", fontSize: 14 }}>
                    We will remind you a few days before so that you can make
                  </Text>
                  <Text style={{ color: "#777A7E", fontSize: 14 }}>
                    sure there is enough money in your account
                  </Text>
                </View>
              </View>
              <View className="items-center mt-5">
                <BlueSignInButton
                  title="Apply"
                  onPress={() => router.push("/Loan/LoanSuccessful")}
                />
              </View>
            </View>
          </View>
        ...
        <BottomSheet height={250} ref={ref}>
          <View style={{ padding: 20, gap: 10 }}>
            ...
            <View style={{ height: height * 0.5 }} className="flex-col">
              ...
              <BlueSignInButton title="Ok" onPress={() => handleCloseModal()} />
            </View>
          </View>
        </BottomSheet>
      </SafeAreaView>

          ...
          >
            ...
            >
              ...
              <View className="flex-col items-center justify-center">
                ...
                Your loan application has been submitted. We will
                </Text>
                <Text className="text-forgotsuccesslight text-[13px]">
                review and get back to you within 2 business
                </Text>
                <Text className="text-forgotsuccesslight text-[13px]">
                  days
                </Text>
            ...
            <View className="items-center">
              <BlueSignInButton title="View" onPress={() => router.push('/Loan/LoanStatus')} />
            </View>
          </View>
        </SafeAreaView>
      </View>

import {
            ...
            >
              ...
              <View className="items-center justify-between flex-row p-4">
                <ShortBlueButton
                  title="Done"
                  color1
                  onPress={() => router.push("/TransactionSendMoney/BankWireSummarySchedule")}
                />
                <ShortWhiteButton
                  title="View receipt"
                  color1
                  onPress={() => router.push('/TransactionSendMoney/BankWireReceiptSchedule')}
                />
              </View>
            </View>
          </SafeAreaView>
  ...
  export default BankWireSuccessSchedule;

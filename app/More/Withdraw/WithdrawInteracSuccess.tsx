          ...
          >
            ...
            <View className="items-center justify-between flex-row p-4">
              <ShortBlueButton
                ...
                color1
                onPress={() =>
                  router.push("/More/Withdraw/WithdrawInteracSummary")
                }
              />
              <ShortWhiteButton
                title="View receipt"
                color1
                onPress={() =>
                  router.push("/More/Withdraw/WithdrawInteracReceipt")
                }
              />
            </View>
          </View>
...
export default WithdrawInteracSuccess;

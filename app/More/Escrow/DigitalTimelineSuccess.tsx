import {
          ...
          >
            ...
            >
              <View className="flex-row justify-between  items-center">
                <TouchableOpacity
                  onPress={() => router.push("/More/Escrow/DigitalTransaction")}
                >
                  <Back />
                </TouchableOpacity>
                <Text className="text-[20px] text-pagetitle">Digital escrow</Text>
                <Text></Text>
              </View>
              <View
              ...
              >
                ...
                <View className="flex-col items-center">
                  ...
                  You have successfully accepted this escrow.
                  </Text>
                </View>
              </View>
              ...
              <View className="items-center justify-between flex-row p-4">
                <BlueSignInButton
                  title="View details"
                  onPress={() => router.push("/More/Escrow/DigitalSummary")}
                />
              </View>
            </View>
          </SafeAreaView>
  ...
  export default DigitalTimelineSuccess;

        ...
        <View className="flex-1 bg-white">
          ...
          >
            <View className="flex-row justify-between items-center mb-1">
              ...
              <Text className="text-[20px] text-pagetitle">Payment successful</Text>
              <Text></Text>
            </View>
            <View
            ...
            >
              ...
              >
                ...
                <View className="flex-col justify-center items-center">
                  ...
                  Your flight payment was successful and your 
                  </Text>
                  <Text className="text-forgotsuccesslight text-[13px]">
                  ticket is ready.
                  </Text>
              ...
              >
                <BlueSignInButton
                  ...
                  onPress={() => router.push("/More/Flight/FlightDownload")}
                />
              </View>
            </View>
          </SafeAreaView>

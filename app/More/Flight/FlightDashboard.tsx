...
const FlightDashboard = () => {
  ...
  return (
    <ScrollView style={{ backgroundColor: "#105CE2" }} className="flex-1">
        ...
        >
          ...
          <View className="flex-row justify-between items-center my-6">
            <View
              ...
              className="flex-row justify-between items-center gap-1 px-2 py-1"
            >
              <Location />
              <Text className="text-white">Alaska, United States</Text>
              <DownCarat />
            </View>
            <Filter />
          </View>
        ...
        >
          ...
          >
            ...
            <View className="flex-col mt-4 relative">
              <MiddleFilter
                style={{ top: height * 0.105, left: width * 0.4, zIndex: 100 }}
                className="absolute"
              />
        ...
        >
          ...
          <View className="flex-row justify-between items-center px-3 mt-3">
            ...
            <View className="flex-col gap-1 items-center">
              ...
              <View><Text style={{color:'#A4A0A0', fontSize: 10}}>7 hours 20 minutes</Text></View>
            </View>
            <View className="flex-col justify-between gap-2">
              <Text style={{ color: "#6E6E6E", fontSize: 13 }}>07:00AM</Text>

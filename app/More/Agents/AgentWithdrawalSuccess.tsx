import {
    ...
    return (
      <View className="flex-1 ">
        <View className="flex-1 bg-white">
          ...
          <TouchableOpacity onPress={() => router.push("/More/Agents/AgentWithdrawalSummary")}>
            <Back />
          </TouchableOpacity>
            ...
            >
              ...
              >
                ...
                <View className="flex-col justify-center items-center">
                  ...
                  Your have withdrawn $90 for Mike Doe 
                  </Text>
                  <Text className="text-forgotsuccesslight text-[13px]">
                  with wiremi ID - WI1245378384 at the
                  </Text>
                  <Text className="text-forgotsuccesslight text-[13px]">
                  fee of $0.567
                  </Text>
  ...
  export default AgentWithdrawalSuccess;

    ...
    <View style={{ backgroundColor: "#ffffff" }} className="flex-1">
      ...
      >
        ...
        >
          ...
          <Text className="text-darktext font-bold">Deposit</Text>
        </View>
        <View
          style={{ borderBottomWidth: 1, borderBottomColor: "#ebebeb" }}
          className="flex-row items-center justify-between p-3"
          ...
          <View style={{ padding: 20, gap: 5 }}>
            ...
            <View className="flex-col gap-8 px-8 mt-2">
              <View className="flex-row justify-between items-center">
                <TouchableOpacity
                  onPress={() => {
                    router.push("/More/Agents/AgentDepositSuccess");
                    handleCloseModal();
                  }}
                >
                  <View>
...
export default AgentDepositSummary;

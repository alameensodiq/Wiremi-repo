import {
    ...
    return (
      <View className="flex-1 ">
        <View className="flex-1 bg-white">
          ...
          <TouchableOpacity onPress={() => router.push("/More/Agents/AgentDepositSummary")}>
            <Back />
          </TouchableOpacity>
            ...
            >
              ...
              >
                ...
                <View className="flex-col justify-center items-center">
                  ...
                  Your have deposited $90 to Mike Doe
                  </Text>
                  <Text className="text-forgotsuccesslight text-[13px]">
  ...
  export default AgentDepositSuccess;

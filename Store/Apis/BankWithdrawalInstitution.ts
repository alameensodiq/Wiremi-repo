...
interface BankWithdrawalInstitutionPayload {
//   goal_name: string;
...
export const BankWithdrawalInstitution = createAsyncThunk<
  APIResponse,
  BankWithdrawalInstitutionPayload,
  ...
  async (
    ...
    try {
      const response = await axios.get<APIResponse>(
        `${BASE_URL}payments/withdrawinstitutions?page=1&page_size=10&country=${code}`,
        {
          headers: {

...
interface MobileWithdrawInstitutionPayload {
//   goal_name: string;
...
export const MobileWithdrawInstitution = createAsyncThunk<
  APIResponse,
  MobileWithdrawInstitutionPayload,
  ...
  async (
    ...
    try {
      const response = await axios.get<APIResponse>(
        `${BASE_URL}payments/withdrawinstitutions?page=1&page_size=10&type=MOMO&country=${code}`,
        {
          headers: {

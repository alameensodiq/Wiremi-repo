...
interface AllInstitutionPayload {
//   goal_name: string;
...
export const AllInstitution = createAsyncThunk<
  APIResponse,
  AllInstitutionPayload,
  ...
  async (
    ...
    try {
      const response = await axios.get<APIResponse>(
        `${BASE_URL}payments/institutions?page=1&page_size=1000&type=MOMO`,
        {
          headers: {

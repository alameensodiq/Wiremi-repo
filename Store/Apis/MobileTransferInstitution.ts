...
interface MobileTransferInstitutionPayload {
//   goal_name: string;
...
export const MobileTransferInstitution = createAsyncThunk<
  APIResponse,
  MobileTransferInstitutionPayload,
  ...
  async (
    ...
    try {
      const response = await axios.get<APIResponse>(
        `${BASE_URL}payments/mobileinstitutionstransfer?page=1&page_size=10&type=MOMO&country=${code}`,
        {
          headers: {
